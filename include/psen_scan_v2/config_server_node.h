...
{
public:
  ConfigServerNode(const rclcpp::Node::SharedPtr& node, const char* config_file_path, const std::string& frame_id);

private:
  rclcpp::Node::SharedPtr node_;
  rclcpp::Publisher<psen_scan_v2::msg::ZoneSetConfiguration>::SharedPtr zoneset_pub_;
};
}  // namespace psen_scan_v2
