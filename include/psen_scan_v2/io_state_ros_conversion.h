...
#include "psen_scan_v2/msg/io_state.hpp"
#include "psen_scan_v2/msg/input_pin_state.hpp"
#include "psen_scan_v2/msg/output_pin_state.hpp"
...
psen_scan_v2::msg::IOState toIOStateMsg(const psen_scan_v2_standalone::IOState& io_state, const std::string& frame_id)
{
  psen_scan_v2::msg::IOState ros_message;
  ...
  ros_message.header.stamp = rclcpp::Time(io_state.timestamp());
